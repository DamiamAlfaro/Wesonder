...
def cslb_conversion(csv_file, address_file, count):
    ...
    for index, row in df_addresses.iloc[count:143305].iterrows():
...
if __name__ == "__main__":
    ...
    address_conversion_file = "/Users/damiamalfaro/Desktop/Europe/testing_wesonder/geolocation_conversion/file_projects_conversion_one.csv"
