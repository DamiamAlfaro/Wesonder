...
'''
NEIN: Let's only extract the links with planetbids related content
'''
...
'''
NEIN: A mechanism to scroll down over the table display of planetbids used in
...
'''
NEIN: Store the rowattribute dataframe into a csv file
'''
...
'''
NEIN: Store the link and awarding body into a csv file if faulty
'''
