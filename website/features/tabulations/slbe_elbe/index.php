<?php
    ...
    $valid_columns = [
        'Name', 'Email', 'PhoneNumber', 'POC', 'Services', 'Licenses'
    ];
    ...
    $total_result = $conn->query("SELECT COUNT(*) AS total FROM finalized_slbe_elbe WHERE $where_sql");
    $total_rows = $total_result->fetch_assoc()['total'];
    $total_pages = ceil($total_rows / $limit);

    // SQL query with WHERE, ORDER BY, LIMIT, and OFFSET
    $sql = "SELECT * FROM finalized_slbe_elbe 
            WHERE $where_sql 
