...
def downloading_cslb_database():
    ...
    for license_tabulation in range(1,total_options_count+1):
        ...
        # Continue with the non-fallible
            ...
            if label_license.text == "HAZ - Hazardous Substance Removal Certification":
                time.sleep(10)
...
def arranging_downloaded_files():
    ...
    downloads_path = "/Users/damiamalfaro/Downloads/"
    ...
    final_df.to_csv('cslb_geolocations_raw_update.csv',index=False)
...
def comparing_past_and_present_contractors():
    ...
    past_file = "https://storage.googleapis.com/wesonder_databases/wesonder_frontend/finalized_cslb_update.csv"
...
def obtaining_new_geolocations_and_finalization():
    ...
    initial_dataframe_link = "https://storage.googleapis.com/wesonder_databases/wesonder_frontend/finalized_cslb_update.csv"
    initial_main_dataframe = pd.read_csv(initial_dataframe_link, low_memory=False)
